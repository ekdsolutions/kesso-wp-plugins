/**
 * Kesso Accessibility Admin JavaScript
 */
...
(function() {
	...
	class KessoColorPicker {
		constructor(wrapper) {
			this.wrapper = wrapper;
			this.input = wrapper.querySelector('.kesso-color-picker-input');
			this.preview = wrapper.querySelector('.kesso-color-picker-preview');
			this.toggle = wrapper.querySelector('.kesso-color-picker-toggle');
			this.dropdown = wrapper.querySelector('.kesso-color-picker-dropdown');
			this.spectrumCanvas = wrapper.querySelector('.kesso-color-picker-canvas');
			this.spectrumPointer = wrapper.querySelector('.kesso-color-picker-pointer');
			this.hueSlider = wrapper.querySelector('.kesso-color-picker-hue');
			this.hueCanvas = this.hueSlider.querySelector('.kesso-color-picker-slider-canvas');
			this.hueThumb = this.hueSlider.querySelector('.kesso-color-picker-slider-thumb');
			this.alphaSlider = wrapper.querySelector('.kesso-color-picker-alpha');
			this.alphaCanvas = this.alphaSlider.querySelector('.kesso-color-picker-slider-canvas');
			this.alphaThumb = this.alphaSlider.querySelector('.kesso-color-picker-slider-thumb');
			this.hexInput = wrapper.querySelector('.kesso-color-picker-hex');
			this.rgbaInput = wrapper.querySelector('.kesso-color-picker-rgba');
	...
	function initColorPickers() {
		const wrappers = document.querySelectorAll('.kesso-color-picker-wrapper');
		wrappers.forEach(wrapper => {
			const fieldId = wrapper.getAttribute('data-field-id');
			const picker = new KessoColorPicker(wrapper);
	...
	// Expose update function globally for jQuery reset handler
	window.kessoUpdateColorPicker = updateColorPicker;
